    ...
    return (
        <>
            <div className="border-b flex justify-between ">
                ...
                <div className="flex items-center flex-col drop">
                    <p>Besion d'aide</p>
                    {/* Drop down menu */}
                    <button
                        id="dropdownDefaultButton"
                        data-dropdown-toggle="dropdown"
                        className="text-text-slate-600 hover:bg-slate-300 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2.5 text-center inline-flex items-center frensh "
                        type="button"
                    >
                        Français{" "}
                        <svg
