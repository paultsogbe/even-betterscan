...
//     const lastPage = Math.ceil(props.data.length / resultsPerPage);
...
//         setCurrentPage(newPage);
//         setScrollPosition(itemRef.current.offsetWidth * (newPage - 1));
//     };

//     return (
//         <div className="flex flex-col bg-background1 m-auto p-auto mb-20">
//             <div
//                 className="flex pb-10 hide-scroll-bar carrousel"
